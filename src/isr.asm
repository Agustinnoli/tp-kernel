...
_isr14:
    ...
    mov eax, cr2 ; direccion virtual que genero el page fault
    push eax
...
_isr32:
    ...
    ;Opcional parte de interrupciones
    ;mov eax, dword [SHARED_TICK_COUNT]
    ;mov edx, dword [SHARED_TICK_COUNT]
    ;shr edx, 16
    ;mov cx, 36
    ;idiv cx
    ;cmp dx, 0
    ...
    jmp far [sched_task_offset] ;duda: que significa este salto??

    .fin:
    ; 3. Actualizamos las estructuras compartidas ante el tick del reloj
    call tasks_tick
    ; 4. Actualizamos la "interfaz" del sistema en pantalla
    call tasks_screen_update ;comentado para la parte de tareas
    popad
    iret ;duda: como se llega a este iret despues del jmp far [sched_task_offset]?
