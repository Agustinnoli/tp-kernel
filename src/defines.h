...
#define GDT_CODE_0_SEL (GDT_IDX_CODE_0 << 3) //0b0000000000001000
#define GDT_DATA_0_SEL (GDT_IDX_DATA_0 << 3) //0b0000000000011000
#define GDT_CODE_3_SEL ((GDT_IDX_CODE_3 << 3) | 3) //0b0000000000010011
#define GDT_DATA_3_SEL ((GDT_IDX_DATA_3 << 3) | 3) //0b0000000000100011
...
#define VIDEO_SEGM_SIZE (SIZE_N * SIZE_M * 2)
